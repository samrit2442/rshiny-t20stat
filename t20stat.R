...
t20 <- read.csv("t20_data_02_Apr_2022.csv", header = T) ### Reading file from external sources
...
body = dashboardBody(
        tabItems(
          tabItem(tabName = "bat",
          span(textOutput("name"), style="font-size: 30px; font-style: bold", tags$hr()),
                    column(12,
            ...
            tabItem(tabName = "about", h2("About the Shiny App"), 
                    ...
                    h5(tags$em(tags$b("*Last updated on April 2, 2022  23:59:59 IST")), align = "right"), ## Date Update
                    tags$br(),
                    tags$br(),
                    tags$br(),
                    tags$br(),
